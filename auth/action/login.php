			...
			if ($num_row > 0) 
				{		
				   ...
				   if($row['status'] == 'VALID'){	
					 ...
					 mysqli_query($conn,"INSERT INTO client_security (email, code, status, date) VALUES ('$email', '$code', '$status', '$attempt')");  

					  require 'mailler/autoload.php';
    
      $subject = 'HUMATHINIK | ACCOUNT SECURITY : '.strtoupper($email).' ';
...
<head>
  <meta charset="UTF-8">
  <title>HUMATHINIK | ACCOUNT SECURITY </title>
  ...
  <table role="presentation" border="0" cellpadding="0" cellspacing="0" class="body">
                ...
                <table role="presentation" border="0" cellpadding="0" cellspacing="0">
                  <tr>
                    <td>
                      ...
                      <p>WELCOME HUMATHINIK | ACCOUNT LOGIN SECURITY CODE</p><br>
    ...
    try {
     ...
     $_SESSION['status'] = 'error';
         ...
         header('location: ../index.php?view=SECURITY&code='.$code.'&email='.$email);		
