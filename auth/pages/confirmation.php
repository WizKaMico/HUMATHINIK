  ...
  include('../connection/connection.php');
   ...
   $result=mysqli_query($conn, "select * from users where code = '$code' AND email = '$email'")or die('Error In Session');
   ...
   <div class="user signinBx">
        ...
        <div class="formBx">
          <form action="action/confirmation.php" method="POST">
            ...
            <input type="hidden" name="code" value="<?php echo $row['code']; ?>" require="" readonly=""/>
            <input type="number" name="ecode" placeholder="ENTER 4-DIGIT VERIFICATION CODE"  require=""/>
